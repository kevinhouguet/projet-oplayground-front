					...
					<div className="firstAreaSection bg-base-200 mx-4 my-2 flex justify-around">
						<div className="textInuputArea">
							...
							<div className="lastNameSection pb-1 flex">
								...
								<input className="input input-warning w-2/5 max-w-xs" type="text" placeholder="Dugenoux" {...register("lastName", { maxLength: 100 })} />
							</div>
							<div className="ageSection pb-1 flex">
								<p className="flex-1 px-4">Age :</p>
								<input className="input input-warning w-2/5 max-w-xs" type="number" placeholder="29" {...register("age", { pattern: /^\S+@\S+$/i })} />
							</div>
							<div className="sexeSection pb-1 flex justify-between">
								<p className="flex-1 px-4">Sexe :</p>
								<select className="input input-warning w-2/5 py-0 max-w-xs"{...register("Sexe", {})}>
					...
					<div className="secondAreaSection bg-base-200 pb2-0 mx-4">
						<div className="textInuputArea">
							<div className="pseudoSection pb-1 pt-1 flex">
								...
								<input className="input input-warning w-2/5 max-w-xs" type="text" placeholder="JeanDu92" {...register("username", { maxLength: 80 })} />
							</div>
							<div className="pseudoSection pb-1 flex">
								<p className="flex-1 px-4">Adresse mail :</p>
								<input className="input input-warning w-2/5 max-w-xs" type="email" placeholder="adressmail@gmail.com" {...register("email", { maxLength: 80 })} />
							</div>
							...
							<div className="newPassword pb-1 flex">
								...
								<input className="input input-warning w-2/5 max-w-xs" type="password" placeholder="Nouveau mot de passe :" {...register("Nouveau mot de passe", { minLength: 8 })} />
							</div>
							<div className="newPasswordConfirmation pb-1 flex">
								<p className="flex-1 px-4">Confirmation du nouveau mot de passe :</p>
								<input className="input input-warning w-2/5 max-w-xs" type="password" placeholder="Confirmation du mot de passe :" {...register("Confirmation du nouveau mot de passe", { min: 8 })} />
							</div>
						</div>
					</div>
